...
void i18n.use(initReactI18next).init({
  ...
  resources: {
    'pt-BR': { translation: {
      overview: 'Visão geral', catalog: 'Catálogo de serviços', tests: 'Testes sintéticos', releases: 'Validações', agents: 'Agentes', help: 'Aprender',
      ...
      loginTitle: 'Entre no SentinelOps', username: 'Usuário', password: 'Senha', login: 'Entrar', logout: 'Sair',
      welcome: 'Sua operação, com contexto.', subtitle: 'Métricas, sinais sintéticos e releases em um só fluxo operacional.',
    ...
    'en-US': { translation: {
      overview: 'Overview', catalog: 'Service catalog', tests: 'Testes sintéticos', releases: 'Validations', agents: 'Agents', help: 'Learn',
