...
docker run --rm -v "$root":/src -w /src golang:1.26.6-bookworm@sha256:116d58cbd88c1297624acc6e967a060012422bacf9930927e23fb719189c6f36 sh -ec 'test -z "$(gofmt -l apps internal demo)" && go vet ./... && go test -race ./...'
